...
public class ForgetPassword extends JFrame implements ActionListener{
    ...
    ForgetPassword(){
        ...
        search.setBounds(300, 20, 100, 25);
        ...
        retrieve.setBounds(300, 140, 100, 25);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==search){
            ...
            try{
                String query= "select * from user where answer= '"+tfanswer.getText()+"'AND username= '"+tfusername.getText()+"'";
                Conn c=new Conn();
